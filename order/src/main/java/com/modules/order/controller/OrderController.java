...
public class OrderController {
    ...
    public R getOrder(@RequestParam Map<String,Object> map,int limit,int page)throws Exception{
        Parameter getOrder = OrderController.class.getMethod("getOrder", Map.class, int.class, int.class).getParameters()[0];
